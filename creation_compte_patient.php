...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $pdo->prepare('SELECT Matricule FROM Patient WHERE Matricule = ?');
    ...
    if (empty($errors)) {
        try {
            ...
            $stmt = $pdo->prepare('INSERT INTO Patient (Matricule, Email, password) VALUES (?, ?, ?)');
            $stmt->execute([$matricule, $email, $hash]);
...
<body>
  ...
  <div class="container d-flex justify-content-center">
    <div class="col-md-8 form-container">
      <h2 class="text-center" style="color:#003366;">Créer un compte patient</h2>
      ...
      <form id="createAccountForm" action="" method="POST" onsubmit="return validateForm()">
        <div class="row">
      ...
      <p class="mt-3 text-center">
        ...
        <a href="connexion_patient.php" class="link-dark">Se connecter</a>
      </p>
    </div>
  </div>
